...
config.tabbar = {
  backend = 'none',
  options = {}, -- the options for the backend, i used this for customize the aspect of the tabbar (in the case u're using lualine xD)
}
...
config.plugins = {
  ...
  specify = {
    decay = {
      dark = false, -- true to enable darker palette
      nvim_tree = {
        contrast = true
      },
    },
