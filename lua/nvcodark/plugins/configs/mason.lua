...
local function load_lspconfig ()
   ...
   local lsp_conf = {
      on_attach = function (client, bufnr)
         ...
         lsp.mkbind(bufnr, 'n', 'gh', require('lspsaga.finder').lsp_finder)
         lsp.mkbind(bufnr, 'n', 'K', require('lspsaga.hover').render_hover_doc)
         lsp.mkbind(bufnr, 'n', 'gi', vim.lsp.buf.implementation)
         lsp.mkbind(bufnr, 'n', 'rn', require('lspsaga.rename').lsp_rename)
         lsp.mkbind(bufnr, 'n', '<space>ca', action.code_action)
         lsp.mkbind(bufnr, 'v', '<space>ca', function ()
